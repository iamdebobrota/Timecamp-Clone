...
const Users = () => {
  ...
  const getUsers = () => {
    fetch(
      `https://timecampclone.herokuapp.com/projectusers/${userid}/projectusers`
    )
      .then((res) => res.json())
      .then((res) => {
        setData(res);
  ...
  const handleDeleteUser = (el) => {
    ...
    fetch(
      `https://timecampclone.herokuapp.com/projectusers/${userid}/projectusers/${singleUserId}`,
      {
        method: "DELETE",
      }
    )
          ...
          <div>
            ...
            {newUserForm && (
              <div className={styles.addNewUsersDiv}>
                ...
                <div className={styles.inviteUsersHeadingDiv}>
                  <span>
                    Each person will receive an email with their login
                    information and a link to your account
                  </span>
                  <span>{"    "}</span>
                  <span>Guest</span>
                </div>
                ...
                >
                  Which user group should they belong to?
                </div>
                <select
                  defaultValue="people"
                ...
                >
                  Which superpowers, if any, should they have?
                </div>
                ...
                <div style={{ marginTop: "15px" }}>
                  ...
                  <span> </span>
                  <span style={{ marginLeft: "15px" }}>
                    Can manage all invoices, rates, projects (Time Tracking
                    Administrator)
                  </span>
                </div>
                <div style={{ marginTop: "15px" }}>
