      ...
      <div className={styles.mainDiv}>
        <div className={styles.leftDivInMain}>
          ...
          <div className="register-wrapper__img--review">
            <img
              alt="img"
              src="https://cdn.timecamp.com/res/css/images/review-icon-signup.1658227855.svg"
            />
          </div>
          <div className={styles.reviewColumns}>
            <div className={styles.reviewColumnSingle}>
              ...
              <img
                alt="img"
                src="https://cdn.timecamp.com/res/css/images/stars-reviews-signup.1658227855.svg"
              />
              <p>
          ...
          <div className={styles.imageIcons}>
            <img
              alt="img"
              src="https://cdn.timecamp.com/res/css/images/leader-summer-reviews-signup.1658227855.svg"
            />
            <img
              alt="img"
              src="https://cdn.timecamp.com/res/css/images/easiest-to-use-icon-review-signup.1658227855.svg"
            />
          </div>
        </div>
