...
{/* benefits */}
      ...
      <div className='grid m-auto bg-white justify-center mt-8' >
        <div className='flex flex-1 w-3/4 m-auto mt-8 cursor-pointer' >
          <div className=' text-start'>

            <div className='border-l-8 mb-4  border-green-600 pl-8 pb-6 shadow-[8px_15px_60px_-15px_rgba(0,0,0,0.3)]'>
              <h3 className='font-bold mt-12 text-xl'>Track a team's performance</h3>
